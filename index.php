    ...
    <div class="container" onclick="onclick">
        ...
        <div class="center">
            ...
            <form method="post" action="create-account.php" method="POST">
                ...
                <input type="email" class="form-control" name="email" aria-describedby="emailHelp" placeholder="Ingresa tu nombre" required>
            ...
            <a href="login.php" title="Login Here">Ya tienes cuenta? Ingresa!</a>
